function Trusted() {
  const items = [
    ...
    },
    {
      ...
      description:
        "Join businesses across Africa enjoying secure payments for every transaction.",
    },
    {
  ...
  return (
    <div className="relative mt-[420px] lg:px-[6.25vw]  mx-4 xl:mx-0">
      <h3 className="text-center my-5 font-medium text-xl md:text-[42px] text-black/90">
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1 gap-7">
        {items.map((item, index) => (
          <div
            className="border border-[#E4E8F1] rounded-[10px] px-5 py-3 "
            key={index}
          >
            ...
            <div className="flex flex-col mt-4 ">
              ...
              <span className="text-[15px] font-normal text-[#5C6474] inline-block whitespace-normal break-words">
                {item.description}
              </span>
            </div>
          </div>
